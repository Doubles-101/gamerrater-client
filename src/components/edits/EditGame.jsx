...
export const EditGame = () => {
    ...
    const handleSubmit = (e) => {
        ...
        fetch(`http://localhost:8000/games/${gameId}`, {
            ...
            body: JSON.stringify({
                ...
                year_released: gameDetails.year_released,
                number_of_players: gameDetails.number_of_players,
                estimated_time_to_play: gameDetails.estimated_time_to_play,
                age_recommendation: gameDetails.age_recommendation,
            }),
        })
    ...
    return (
        <div className="max-w-lg mx-auto mt-10 p-8 border rounded-lg shadow-lg bg-white">
            <h1 className="text-2xl font-bold mb-6">Edit Your Game</h1>
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <fieldset>
                    ...
                    <input
                        type="number"
                        name="year_released"
                        value={gameDetails.year_released}
                        onChange={handleChange}
                        min="1900"
                        max="2100"
                        required
                ...
                <fieldset>
                    ...
                    <input
                        ...
                        value={gameDetails.number_of_players}
                        onChange={handleChange}
                        min="0"
                        max="1000000000"
                        required
                ...
                <fieldset>
                    ...
                    <input
                        ...
                        value={gameDetails.estimated_time_to_play}
                        onChange={handleChange}
                        required
                        className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
                    />
                ...
                <fieldset>
                    ...
                    <input
                        ...
                        value={gameDetails.age_recommendation}
                        onChange={handleChange}
                        min="1"
                        max="120"
                        required
...
{/* 
                <fieldset>
                    <label>Select an category:</label>
                        <select id="categories" name="categories" onChange={handleCategoryChange} required>
